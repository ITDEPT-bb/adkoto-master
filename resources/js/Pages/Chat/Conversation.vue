<template>
    ...
    <AuthenticatedLayout>
        <div
            class="flex-1 justify-between max-w-7xl mx-auto max-[740px]:mt-16 max-[450px]:mt-0 bg-white dark:bg-slate-950 dark:border-none rounded-lg border flex flex-col min-[360px]:h-[630px] max-[359px]:h-[620px] min-[400px]:h-[790px] min-[810px]:h-[1080px] md:h-[800px] lg:h-[1100px] xl:h-full scrollbar-thin"
        >
            <!-- <div
