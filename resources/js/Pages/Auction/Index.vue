        ...
        <div class="h-full overflow-y-auto p-4 scrollbar-thin">
            ...
            >
                <Disclosure v-slot="{ open }">
                    ...
                    <DisclosurePanel>
                        <div
                            class="col-span-12 lg:col-span-3 bg-white dark:bg-slate-950 px-4 py-4 lg:px-6 lg:py-6 rounded-lg shadow-sm flex flex-col justify-between"
                        >
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 max-w-7xl mx-auto"
            >
                <div
                ...
                <div
                    class="col-span-12 lg:col-span-3 bg-white dark:bg-slate-950 dark:text-white px-4 py-4 lg:px-6 lg:py-6 rounded-lg shadow-sm hidden lg:block"
                >
