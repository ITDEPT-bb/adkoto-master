<template>
    ...
    <AuthenticatedLayout>
        <div
            class="max-w-7xl mx-auto h-full overflow-y-auto p-4 scrollbar-thin dark:bg-slate-950"
        >
            <KalakalMenu />
            <div class="px-4 mx-auto 2xl:px-0 my-4">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                    ...
                    <div class="relative">
                        ...
                        <button
                            @click="prevImage"
                            class="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white dark:bg-slate-700 text-blue-500 dark:text-white font-bold p-2 rounded-full"
                        >
                            &lt;
                        </button>
                        <button
                            @click="nextImage"
                            class="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white dark:bg-slate-700 text-blue-500 dark:text-white font-bold p-2 rounded-full"
                        >
                            &gt;
                        </button>
                    </div>
                    ...
                    <div class="mt-6 sm:mt-8 lg:mt-0">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="flex gap-3 hover:underline dark:text-white"
                                >
                                    <MessageIcon />
