<template>
    ...
    <AuthenticatedLayout>
        <div
            class="max-w-4xl mx-auto my-2 h-full overflow-y-auto p-6 bg-white dark:bg-slate-950 shadow-md rounded-lg scrollbar-thin"
        >
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        v-model="form.title"
                        required
                        class="mt-1 block w-full border-gray-300 dark:bg-slate-950 dark:text-white rounded-md shadow-sm"
                ...
                <div>
                    ...
                    <select
                        ...
                        class="mt-1 block w-full border-gray-300 dark:bg-slate-950 dark:text-white rounded-md shadow-sm"
                        placeholder="Enter advertisement sub-category"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="mt-1 block w-full border-gray-300 dark:bg-slate-950 dark:text-white rounded-md shadow-sm"
                        placeholder="Enter advertisement location"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        multiple
                        class="mt-1 block w-full border-gray-300 dark:bg-slate-950 dark:text-white rounded-md shadow-sm"
                        placeholder="Enter advertisement images"
                    />
                </div>
