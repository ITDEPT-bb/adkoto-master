...
const isPendingToGroup = computed(
    () => props.group.role && props.group.status === "pending"
);
...
const handleChatClick = async (groupId) => {
    ...
    try {
        const response = await axios.get(
            route("group.handle", { group_id: groupId })
        );
...
<template>
    <AuthenticatedLayout>
        ...
        <div
            class="mx-auto max-w-7xl h-full overflow-auto scrollbar-thin p-0.5"
        >
            <div class="px-4">
                <div
            ...
            <div class="border-t m-4 mt-0">
                <TabGroup>
                    ...
                    <template
                        v-if="
                            group.group_status === 'public' || isJoinedToGroup
                        "
                    >
                        <TabPanels class="mt-2">
                            <TabPanel>
                                ...
                                <div
                                    ...
                                    class="py-8 text-center dark:text-gray-100"
                                >
                                    You don't have permission to view these
                                    posts.
                                </div>
                            </TabPanel>
                            ...
                            <TabPanel>
                                <template
                                    v-if="isCurrentUserAdmin && isJoinedToGroup"
                                >
                    ...
                    <template v-else>
                        <div class="py-8 text-center dark:text-gray-100">
                            <p>
                                This is a private group. You need to join it to
                                see these content.
                            </p>
                        </div>
                    </template>
            ...
            <!-- Leave Modal -->
            <TransitionRoot as="template" :show="openLeave">
                <Dialog class="relative z-10" @close="openLeave = false">
                    <TransitionChild
                        as="template"
                        enter="ease-out duration-300"
                        enter-from="opacity-0"
