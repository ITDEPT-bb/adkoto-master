...
const cropAndSubmit = async () => {
	...
	if (canvas) {
		...
		try {
			const response = await axiosClient.post("/profile/update-cover", formData, {
				headers: {
...
<template>
	<Head title="Update Your Cover" />

	<AuthenticatedLayout>
		<div class="max-w-7xl mx-auto h-full overflow-y-auto p-4 scrollbar-thin">
			<h1 class="text-3xl font-bold text-gray-900 mb-6">Update Your Cover Photo</h1>
