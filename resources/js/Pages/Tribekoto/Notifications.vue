<template>
    ...
    <AuthenticatedLayout>
        ...
        <div
            class="container mx-auto p-4 py-2 h-full overflow-y-auto scrollbar-thin"
        >
            ...
            <ul
                v-else
                class="max-w-full divide-y divide-gray-200 bg-white dark:bg-slate-950 rounded-lg shadow-lg"
            >
                <template
                ...
                >
                    ...
                    >
                        <li
                            class="py-4 px-6 cursor-pointer flex items-start space-x-4 border-b last:border-b-0 hover:bg-slate-500 transition-colors duration-300 ease-in-out"
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-row gap-2">
                                    ...
                                    <template
                                        v-if="notification.data.reaction_image"
                                    >
                                        <img
                                            :src="
                                                notification.data.reaction_image
                                            "
                                            :alt="notification.data.reaction"
                                    ...
                                    <template
                                        v-else-if="notification.data.icon"
                                    >
                                        <span
                                            class="w-6 h-6 flex items-center justify-center text-md"
                                        >
