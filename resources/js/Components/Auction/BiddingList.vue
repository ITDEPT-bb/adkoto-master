<template>
	<div class="p-4 bg-white rounded h-full overflow-y-auto scrollbar-thin">
		<h2 class="text-xl font-bold text-gray-900 dark:text-white">Bidding List</h2>
		<div class="mt-4">
			...
			<ul class="space-y-2">
				...
				<li
					...
					:key="item.id"
					:class="{
						'bg-green-100 dark:bg-green-900': item.bid_amount === highestBid,
						'bg-gray-100 dark:bg-gray-800': item.bid_amount !== highestBid,
					}"
