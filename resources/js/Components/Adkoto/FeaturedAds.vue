<template>
	<div class="bg-white p-4 shadow my-2 rounded-lg">
...
const firstCarouselAds = computed(() => featuredAds.value.filter((ad, index) => index % 2 === 0));
const secondCarouselAds = computed(() => featuredAds.value.filter((ad, index) => index % 2 !== 0));
</script>
