								...
								<div class="sm:flex sm:items-start">
									...
									<div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
										<DialogTitle
											...
											<span class="text-blue-400 underline">{{ kalakalitem.name }}</span>
										</DialogTitle>
										<div class="mt-2">
											<p class="text-sm text-gray-500">
												Choose the auction type you want to apply.
											</p>
											<div class="flex mt-4">
												...
												<div class="ms-2 text-sm">
													<label
														...
														>Normal Bidding <span>(₱ {{ normalPrice }})</span></label
													>
													<p
														id="helper-radio-text"
														class="text-xs font-normal text-start text-gray-500 dark:text-gray-300">
														Choose this option to display your item on the Normal Bidding List
														Section.
													</p>
												</div>
											</div>
											...
											<div class="flex mt-4">
												...
												<div class="ms-2 text-sm">
													<label
														for="helper-radio"
														class="font-semibold flex justify-between text-gray-900 dark:text-gray-300"
														>Live Bidding <span>(₱ {{ livePrice }})</span></label
													>
													<p
														id="helper-radio-text"
														class="text-xs font-normal text-start text-gray-500 dark:text-gray-300">
														Choose this option to display your item on the Live Bidding List
														Section.
													</p>
												</div>
											</div>
