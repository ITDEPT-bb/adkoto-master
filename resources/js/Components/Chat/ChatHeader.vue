<template>
	<div
		class="flex flex-col sm:flex-row sm:items-center justify-between py-3 px-4 rounded-lg border-b-2 border-gray-200"
		...
		<div class="flex items-center space-x-4 sm:mb-0">
			...
			<div class="flex flex-col sm:flex-row sm:items-center leading-tight">
				<div class="flex items-center gap-10">
					<div class="sm:text-lg text-md font-semibold text-center sm:text-left text-white">
						{{ user.name }} {{ user.surname }}
						<span class="text-sm font-light text-white sm:block hidden">@{{ user.username }}</span>
					</div>
		...
		<div
			...
			<Link :href="route('profile', user.username)">
				<button class="flex items-center w-full px-4 py-2 text-gray-800 hover:bg-gray-200">
