                    ...
                    >
                        ...
                        >
                            ...
                            <div class="mt-2">
                                <!-- Main Content -->
                                <div
                                    class="max-h-[600px] overflow-y-auto space-y-4 px-4 py-6"
                                >
                                    <!-- User List -->
                                    <div
                                    ...
                                    >
                                        <div class="flex flex-col h-full">
                                            <!-- Timer Display -->
                                            <div
                                                class="absolute top-4 left-4 text-white text-lg z-50"
                                            >
                                                Time remaining:
                                                {{ formattedTime }}
                                            </div>
                                ...
                                >
                                    <div
                                        class="text-center bg-white p-6 rounded shadow-md"
                                    >
...
const startCall = async (user) => {
    ...
    try {
        ...
        channelName.value = generateChannelName(authUser.id, user.id);
