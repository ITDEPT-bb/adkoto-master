	...
	<teleport to="body">
		<TransitionRoot
			...
			<Dialog
				...
				<div class="fixed inset-0 overflow-y-auto scrollbar-thin">
					<div class="flex min-h-full items-center justify-center p-4 text-center">
						<TransitionChild
							...
							<DialogPanel
								class="w-full max-w-5xl transform overflow-hidden rounded bg-white dark:bg-slate-900 text-left align-middle shadow-xl transition-all">
								<DialogTitle
									v-if="title"
									as="h3"
