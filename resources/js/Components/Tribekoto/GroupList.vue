...
import SuggestedGroupListItems from "./SuggestedGroupListItems.vue";
...
<template>
    ...
    >
        <div class="block lg:hidden">
            <Disclosure v-slot="{ open }">
                ...
                <DisclosurePanel>
                    ...
                    <h2 class="text-xl font-bold rounded p-2">
                        Suggested Groups
                    </h2>
                    <SuggestedGroupListItems :groups="suggestedGroups" />
                </DisclosurePanel>
            </Disclosure>
        </div>
        <div class="h-full overflow-hidden flex-col hidden lg:flex">
            ...
            <div class="h-full items-center md:border-t-2 md:pt-8 mt-2">
                <div class="flex justify-between">
                    <h2 class="text-xl font-bold">Suggested Groups</h2>
                </div>
                <SuggestedGroupListItems :groups="suggestedGroups" />
            </div>
        </div>
