<template>
    ...
    >
        <DialogPanel
            class="relative w-full max-w-sm h-auto mx-auto p-4 bg-white rounded-lg flex flex-col items-center"
        >
            <!-- Avatar Image -->
            <img
                :src="imageSrc || '/img/default_avatar.webp'"
                class="w-24 h-24 sm:w-48 sm:h-48 object-cover rounded-full"
                alt="Avatar Image"
            />
