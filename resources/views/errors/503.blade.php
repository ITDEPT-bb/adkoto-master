...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    {{-- <div class="text-center">
        <h1 class="text-6xl font-bold text-gray-800 mb-4">We'll be back soon!</h1>
        <p class="text-xl text-gray-600 mb-8">Sorry for the inconvenience but we're performing some maintenance at the
            moment. We'll be back online shortly!</p>
        <img src="https://via.placeholder.com/400x300" alt="Maintenance Image" class="mx-auto mb-8">
        <p class="text-gray-500">— The Team</p>
    </div> --}}
    <div class="w-full h-screen flex flex-col items-center justify-between">
        <div class="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0">
            ...
            <p class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8">Website under maintenance, We'll
                be back soon!</p>
            <p class="text-gray-700 uppercase mt-4">Sorry for the inconvenience but we're performing some
                maintenance at the
                moment. We'll be back online shortly!</p>
        </div>
